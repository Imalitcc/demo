...
class Dao{
  ...
  private $imD;
   ...
   {
                  $this->sql="insert into student(id,email,Firstname,lastname,address,dob,keeper,contactnumber) values('','".$StudentO->getEmail()."','".$StudentO->getFirstName()."','".$StudentO->getLastName()."','".$StudentO->getAddress()."','".$StudentO->getDob()."','".$StudentO->getKeeper()."','".$StudentO->getContactNumber()."');";
